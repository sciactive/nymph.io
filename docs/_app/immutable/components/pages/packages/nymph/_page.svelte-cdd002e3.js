...
export default class Todo extends Entity<TodoData> {
  ...
  async $getOtherTodos() {
    ...
    database, save data to it, and define different data types.`),U=l(),w=o("header"),P=o("h2"),Y=d("Installation"),G=l(),ue(g.$$.fragment),W=l(),b=o("header"),k=o("h2"),F=d("Drivers"),J=l(),m=o("p"),K=d("To use Nymph, you need a database driver. Nymph.js provides a "),N=o("a"),V=d("MySQL driver"),X=d(", "),D=o("a"),Z=d("PostgreSQL driver"),ee=d(`, and a
    `),H=o("a"),te=d("SQLite3 driver"),ae=d("."),se=l(),S=o("header"),A=o("h2"),oe=d("Usage"),re=l(),L=o("p"),ne=d("Here's an overview:"),ie=l(),ue(v.$$.fragment),de=l(),ue(_.$$.fragment),he=l(),j=o("header"),Q=o("h2"),le=d("Options"),ce=l(),E=o("p"),me=d("See the "),f=o("a"),pe=d("config declaration file"),fe=d("."),this.h()},l(i){const C=We("svelte-lxz0w1",document.head);y=Fe(C,!1),x=Oe(),C.forEach(s),R=c(i),t=r(i,"SECTION",{});var a=n(t);T=r(a,"HEADER",{class:!0});var we=n(T);$=r(we,"H1",{style:!0});var be=n($);M=h(be,"Nymph"),be.forEach(s),we.forEach(s),z=c(a),q=r(a,"P",{});var Ne=n(q);B=h(Ne,`The Nymph core provides the base level classes and utilities to query the
    database, save data to it, and define different data types.`),Ne.forEach(s),U=c(a),w=r(a,"HEADER",{class:!0});var De=n(w);P=r(De,"H2",{});var He=n(P);Y=h(He,"Installation"),He.forEach(s),De.forEach(s),G=c(a),ye(g.$$.fragment,a),W=c(a),b=r(a,"HEADER",{class:!0});var Se=n(b);k=r(Se,"H2",{});var je=n(k);F=h(je,"Drivers"),je.forEach(s),Se.forEach(s),J=c(a),m=r(a,"P",{});var u=n(m);K=h(u,"To use Nymph, you need a database driver. Nymph.js provides a "),N=r(u,"A",{href:!0});var xe=n(N);V=h(xe,"MySQL driver"),xe.forEach(s),X=h(u,", "),D=r(u,"A",{href:!0});var qe=n(D);Z=h(qe,"PostgreSQL driver"),qe.forEach(s),ee=h(u,`, and a
    `),H=r(u,"A",{href:!0});var Pe=n(H);te=h(Pe,"SQLite3 driver"),Pe.forEach(s),ae=h(u,"."),u.forEach(s),se=c(a),S=r(a,"HEADER",{class:!0});var ke=n(S);A=r(ke,"H2",{});var Ae=n(A);oe=h(Ae,"Usage"),Ae.forEach(s),ke.forEach(s),re=c(a),L=r(a,"P",{});var Le=n(L);ne=h(Le,"Here's an overview:"),Le.forEach(s),ie=c(a),ye(v.$$.fragment,a),de=c(a),ye(_.$$.fragment,a),he=c(a),j=r(a,"HEADER",{class:!0});var Qe=n(j);Q=r(Qe,"H2",{});var Ce=n(Q);le=h(Ce,"Options"),Ce.forEach(s),Qe.forEach(s),ce=c(a),E=r(a,"P",{});var I=n(E);me=h(I,"See the "),f=r(I,"A",{href:!0,target:!0,rel:!0});var Re=n(f);pe=h(Re,"config declaration file"),Re.forEach(s),fe=h(I,"."),I.forEach(s),a.forEach(s),this.h()},h(){document.title="Nymph - Packages - Nymph.js",y.a=x,Je($,"font-size","3em"),p(T,"class","major"),p(w,"class","major"),p(b,"class","major"),p(N,"href",$e+"/packages/driver-mysql"),p(D,"href",$e+"/packages/driver-postgresql"),p(H,"href",$e+"/packages/driver-sqlite3"),p(S,"class","major"),p(j,"class","major"),p(f,"href","https://github.com/sciactive/nymphjs/tree/master/packages/nymph/src/conf/d.ts"),p(f,"target","_blank"),p(f,"rel","external")},m(i,C){y.m(Ve,document.head),e(document.head,x),Ie(i,R,C),Ie(i,t,C),e(t,T),e(T,$),e($,M),e(t,z),e(t,q),e(q,B),e(t,U),e(t,w),e(w,P),e(P,Y),e(t,G),ge(g,t,null),e(t,W),e(t,b),e(b,k),e(k,F),e(t,J),e(t,m),e(m,K),e(m,N),e(N,V),e(m,X),e(m,D),e(D,Z),e(m,ee),e(m,H),e(H,te),e(m,ae),e(t,se),e(t,S),e(S,A),e(A,oe),e(t,re),e(t,L),e(L,ne),e(t,ie),ge(v,t,null),e(t,de),ge(_,t,null),e(t,he),e(t,j),e(j,Q),e(Q,le),e(t,ce),e(t,E),e(E,me),e(E,f),e(f,pe),e(E,fe),O=!0},p:Ke,i(i){O||(ve(g.$$.fragment,i),ve(v.$$.fragment,i),ve(_.$$.fragment,i),O=!0)},o(i){_e(g.$$.fragment,i),_e(v.$$.fragment,i),_e(_.$$.fragment,i),O=!1},d(i){s(x),i&&y.d(),i&&s(R),i&&s(t),Ee(g),Ee(v),Ee(_)}}}class rt extends Be{constructor(y){super(),Ue(this,y,null,Ze,Ye,{})}}export{rt as default};
