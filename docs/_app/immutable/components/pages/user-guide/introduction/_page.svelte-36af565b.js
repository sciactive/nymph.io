import{S as pt,i as yt,s as ut,a as d,k as n,q as s,E as mt,h as t,c,l as i,m as r,r as o,p as We,n as y,b as F,C as e,B as $e}from"../../../../chunks/index-8e853c83.js";import{b as ft}from"../../../../chunks/paths-b4419565.js";function vt(ct){let I,a,P,D,K,Q,T,Z,ee,j,U,te,ae,h,ne,x,se,ie,k,re,oe,v,le,he,C,de,ce,H,pe,ye,ue,q,me,fe,G,ve,ge,O,be,we,g,Ee,R,Ne,_e,Ie,W,Pe,De,$,je,Ae,A,J,Se,Te,b,Ue,w,xe,ke,Ce,E,He,N,qe,Ge,V,S,m,Y,Oe,_,f,Re;return{c(){I=d(),a=n("section"),P=n("header"),D=n("h1"),K=s("Introduction"),Q=d(),T=n("p"),Z=s(`Nymph is an ORM for Node.js and the browser, written in TypeScript. Nymph
    ...
    `),H=n("code"),pe=s("return await super.$save();"),ye=s(`. This means that during
    development, you don't need to worry about managing schemas at all, but you
    still get the benefit of strictly typed data checks in production.`),ue=d(),q=n("p"),me=s(`All entities are given a globally unique identifier (GUID), which is a
    ...
    browse the `),N=n("a"),qe=s("Legacy API docs"),Ge=s("."),V=d(),S=n("section"),m=n("div"),Y=n("div"),Oe=d(),_=n("div"),f=n("a"),Re=s("Next: Creating Entities"),this.h()},l(p){mt("svelte-6cxoo7",document.head).forEach(t),I=c(p),a=i(p,"SECTION",{});var l=r(a);P=i(l,"HEADER",{class:!0});var Je=r(P);D=i(Je,"H1",{style:!0});var Ye=r(D);K=o(Ye,"Introduction"),Ye.forEach(t),Je.forEach(t),Q=c(l),T=i(l,"P",{});var Be=r(T);Z=o(Be,`Nymph is an ORM for Node.js and the browser, written in TypeScript. Nymph
    data objects, called entities, are accessed just like plain objects. Nymph
    includes a REST server and a Publish/Subscribe server. It used to be a PHP
    library and was migrated to Node.js in 2021.`),Be.forEach(t),ee=c(l),j=i(l,"HEADER",{class:!0});var Ve=r(j);U=i(Ve,"H2",{});var Le=r(U);te=o(Le,"Understanding Nymph Applications"),Le.forEach(t),Ve.forEach(t),ae=c(l),h=i(l,"P",{});var u=r(h);ne=o(u,"Data in Nymph is stored and manipulated in objects called "),x=i(u,"STRONG",{});var Me=r(x);se=o(Me,"entities"),Me.forEach(t),ie=o(u,`. Entities can hold most types of data available in JavaScript, including
    other entities. Entities are not strictly structured, so data of any type
    can be added and saved just by assigning a property on the entity and
    calling `),k=i(u,"CODE",{});var Xe=r(k);re=o(Xe,"$save"),Xe.forEach(t),oe=o(u,`. This makes data manipulation and rapid
    prototyping in Nymph very easy. Then when you're ready to launch to
    production, you would use a validation library to enforce a schema for your
    entities.
    `),v=i(u,"A",{href:!0,target:!0});var ze=r(v);le=o(ze,"Joi"),ze.forEach(t),he=o(u,`
    is a good one. You can do this in the
    `),C=i(u,"CODE",{});var Fe=r(C);de=o(Fe,"$save"),Fe.forEach(t),ce=o(u,`
    method on your entities before calling
    `),H=i(u,"CODE",{});var Ke=r(H);pe=o(Ke,"return await super.$save();"),Ke.forEach(t),ye=o(u,`. This means that during
    development, you don't need to worry about managing schemas at all, but you
    still get the benefit of strictly typed data checks in production.`),u.forEach(t),ue=c(l),q=i(l,"P",{});var Qe=r(q);me=o(Qe,`All entities are given a globally unique identifier (GUID), which is a
    random, cryptographically secure, 12 byte integer, encoded in a 24
    character, lowercase HEX string. Since these are random and quite large,
    there should never be any two entities in any Nymph installation with the
    same GUIDs (unless that's done on purpose). Nymph also provides UIDs, which
    ...
    browse the `),N=i(X,"A",{href:!0,rel:!0});var ot=r(N);qe=o(ot,"Legacy API docs"),ot.forEach(t),Ge=o(X,"."),X.forEach(t),l.forEach(t),V=c(p),S=i(p,"SECTION",{});var lt=r(S);m=i(lt,"DIV",{class:!0});var z=r(m);Y=i(z,"DIV",{class:!0}),r(Y).forEach(t),Oe=c(z),_=i(z,"DIV",{class:!0,style:!0});var ht=r(_);f=i(ht,"A",{href:!0,class:!0,style:!0});var dt=r(f);Re=o(dt,"Next: Creating Entities"),dt.forEach(t),ht.forEach(t),z.forEach(t),lt.forEach(t),this.h()},h(){document.title="Introduction - User Guide - Nymph.js",We(D,"font-size","3em"),y(P,"class","major"),y(j,"class","major"),y(v,"href","https://joi.dev/"),y(v,"target","_blank"),y(A,"class","major"),y(w,"href","/api/latest/"),y(w,"rel","external"),y(N,"href","/api/legacy/3.0.0/"),y(N,"rel","external"),y(Y,"class","col-6 col-12-small"),y(f,"href",ft+"/user-guide/creating-entities"),y(f,"class","button"),We(f,"margin",".5em"),y(_,"class","col-6 col-12-small"),We(_,"text-align","end"),y(m,"class","row")},m(p,B){F(p,I,B),F(p,a,B),e(a,P),e(P,D),e(D,K),e(a,Q),e(a,T),e(T,Z),e(a,ee),e(a,j),e(j,U),e(U,te),e(a,ae),e(a,h),e(h,ne),e(h,x),e(x,se),e(h,ie),e(h,k),e(k,re),e(h,oe),e(h,v),e(v,le),e(h,he),e(h,C),e(C,de),e(h,ce),e(h,H),e(H,pe),e(h,ye),e(a,ue),e(a,q),e(q,me),e(a,fe),e(a,G),e(G,ve),e(a,ge),e(a,O),e(O,be),e(a,we),e(a,g),e(g,Ee),e(g,R),e(R,Ne),e(g,_e),e(a,Ie),e(a,W),e(W,Pe),e(a,De),e(a,$),e($,je),e(a,Ae),e(a,A),e(A,J),e(J,Se),e(a,Te),e(a,b),e(b,Ue),e(b,w),e(w,xe),e(b,ke),e(a,Ce),e(a,E),e(E,He),e(E,N),e(N,qe),e(E,Ge),F(p,V,B),F(p,S,B),e(S,m),e(m,Y),e(m,Oe),e(m,_),e(_,f),e(f,Re)},p:$e,i:$e,o:$e,d(p){p&&t(I),p&&t(a),p&&t(V),p&&t(S)}}}class wt extends pt{constructor(I){super(),yt(this,I,null,vt,ut,{})}}export{wt as default};
