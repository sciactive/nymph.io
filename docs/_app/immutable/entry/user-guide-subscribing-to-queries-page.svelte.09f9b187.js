import{S as bt,i as dt,s as mt,R as pt,e as lt,a as l,k as o,q as n,y as L,F as ft,T as yt,h as a,c as h,l as u,m as c,r as i,z as X,p as Z,n as p,C as e,b as ee,A as te,D as gt,g as ae,d as se,B as re}from"../chunks/index.2f30a1c2.js";import{H as ne,g as vt}from"../chunks/github.8af4b809.js";import{t as ie}from"../chunks/typescript.7dd1ec19.js";import{b as ze}from"../chunks/paths.b3a4b0de.js";function wt(ht){let v,I,R,t,q,k,oe,ue,O,ce,le,w,he,D,be,de,me,b,pe,N,fe,ye,W,ge,ve,we,E,Ee,H,_e,Se,_,$e,d,Pe,Y,Te,qe,Q,ke,De,je,S,xe,m,Ce,B,Ae,Ue,M,Ie,Oe,Ne,$,We,V,He,Ye,z,Qe,F,j,f,x,y,Be,Me,P,g,Ve,G;return E=new ne({props:{language:ie,code:`let smiths: (User & UserData)[] = [];
...
onDestroy(() => {
  subscription.unsubscribe();
    ...
    in due time by the PubSub server.`),F=l(),j=o("section"),f=o("div"),x=o("div"),y=o("a"),Be=n("Previous: Entity Querying"),Me=l(),P=o("div"),g=o("a"),Ve=n("Next: Entity Class"),this.h()},l(r){const T=ft("svelte-4wlam7",document.head);v=yt(T,!1),I=lt(),T.forEach(a),R=h(r),t=u(r,"SECTION",{});var s=c(t);q=u(s,"HEADER",{class:!0});var Re=c(q);k=u(Re,"H1",{style:!0});var Fe=c(k);oe=i(Fe,"Subscribing to Queries"),Fe.forEach(a),Re.forEach(a),ue=h(s),O=u(s,"P",{});var Ge=c(O);ce=i(Ge,`Subscribing to a query lets you receive updates to that query. This is a
    powerful tool for collaborative apps. It's also just as easy as making a
    regular entity query.`),Ge.forEach(a),le=h(s),w=u(s,"P",{});var J=c(w);he=i(J,"Before we get started, you can follow the "),D=u(J,"A",{href:!0});var Je=c(D);be=i(Je,"PubSub Server Package"),Je.forEach(a),de=i(J," page to set up a Nymph PubSub server."),J.forEach(a),me=h(s),b=u(s,"P",{});var C=c(b);pe=i(C,"You can use the "),N=u(C,"CODE",{});var Ke=c(N);fe=i(Ke,"subscribeEntities"),Ke.forEach(a),ye=i(C,` method on PubSub to subscribe
    to a query. It will return a function you can call to subscribe to the
    query. That function accepts a resolve and reject callback, similar to a
    promise. The resolve function will receive an update, which will at first be
    an array of entities, then will be an update object with instructions that
