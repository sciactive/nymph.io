import{S as ua,i as ya,s as fa,R as va,e as oa,a as p,k as s,q as t,y as sa,F as ga,T as Ea,h as o,c as m,l as n,m as i,r as a,z as na,p as M,n as v,C as e,b as ve,A as ia,D as wa,g as ra,d as la,B as da}from"../chunks/index.2f30a1c2.js";import{H as ca,g as Ta}from"../chunks/github.8af4b809.js";import{t as ha}from"../chunks/typescript.7dd1ec19.js";import{b as pa}from"../chunks/paths.b3a4b0de.js";function _a(ma){let b,z,de,r,k,J,ge,Ee,C,we,R,Te,_e,$e,N,V,De,be,x,Ce,j,A,Ne,xe,I,je,u,Ie,W,Oe,Pe,F,Se,ke,U,Je,Ve,G,Ae,qe,Be,E,He,K,Ye,Me,L,ze,Re,We,w,Fe,Q,Ue,Ge,X,Ke,Le,Qe,c,Xe,Z,Ze,et,ee,tt,at,te,ot,st,ae,nt,it,oe,rt,lt,dt,O,ct,se,ht,pt,mt,h,ut,ne,yt,ft,ie,vt,gt,T,Et,wt,re,Tt,_t,le,$t,Dt,ce,q,_,B,$,bt,Ct,P,D,Nt,he;return x=new ca({props:{language:ha,code:`import { Entity, Selector, nymphJoiProps } from '@nymphjs/nymph';
...
const Todo = nymph.addEntityClass(TodoClass);`}}),{c(){b=new va(!1),z=oa(),de=p(),r=s("section"),k=s("header"),J=s("h1"),ge=t("Defining Entities"),Ee=p(),C=s("p"),we=t("To create a new type of data object in Nymph, you extend the "),R=s("code"),Te=t("Entity"),_e=t(` class. This is equivalent to creating a new table in a relational database.
    ...
    property is set to false and the `),F=s("code"),Se=t("name"),ke=t(` property is set to an
    ...
    `),U=s("code"),Je=t("this.$data"),Ve=t(`. The
    ...
    you have to use these instances.`),We=p(),w=s("p"),Fe=t("In Node.js, the etype is set to "),Q=s("code"),Ue=t('"todo"'),Ge=t(`. The etype of an entity
    ...
    property is set to false and the `),F=n(g,"CODE",{});var kt=i(F);Se=a(kt,"name"),kt.forEach(o),ke=a(g,` property is set to an
    empty string). You can see that from within the methods of an entity, the
    entity's data (other than guid, cdate, mdate, and tags) are accessed from
    `),U=n(g,"CODE",{});var Jt=i(U);Je=a(Jt,"this.$data"),Jt.forEach(o),Ve=a(g,`. The
    ...
    maintain a persistent DB connection during a transaction. On the client, these
    instances will know how to communicate with the configured REST server. Basically,
    you have to use these instances.`),H.forEach(o),We=m(d),w=n(d,"P",{});var Y=i(w);Fe=a(Y,"In Node.js, the etype is set to "),Q=n(Y,"CODE",{});var Bt=i(Q);Ue=a(Bt,'"todo"'),Bt.forEach(o),Ge=a(Y,`. The etype of an entity
    determines which table(s) the entity will be placed in. When you search for
    an entity, you give Nymph a class. Nymph will use that class' etype to
    determine where to search for entities. If you don't provide a class, the
    ...
    of this feature.`),y.forEach(o),dt=m(d),O=n(d,"P",{});var ye=i(O);ct=a(ye,"On both the Node.js class and the client class, the class name is set in the "),se=n(ye,"CODE",{});var Ft=i(se);ht=a(Ft,"class"),Ft.forEach(o),pt=a(ye,` static property. This class name should match on each side. It is how Nymph
    maps the client class to the Node.js class and vice versa.`),ye.forEach(o),mt=m(d),h=n(d,"P",{});var f=i(h);ut=a(f,"Finally, in Node.js, the "),ne=n(f,"CODE",{});var Ut=i(ne);yt=a(Ut,"Todo"),Ut.forEach(o),ft=a(f,` class validates all of its data
