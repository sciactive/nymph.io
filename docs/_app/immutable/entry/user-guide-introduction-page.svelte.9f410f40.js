import{S as pt,i as ut,s as yt,a as d,k as n,q as s,F as mt,h as t,c,l as i,m as r,r as o,p as We,n as p,b as F,C as e,D as $e}from"../chunks/index.2f30a1c2.js";import{b as ft}from"../chunks/paths.b3a4b0de.js";function vt(ct){let I,a,P,D,K,Q,T,Z,ee,j,U,te,ae,h,ne,x,se,ie,k,re,oe,m,le,he,C,de,ce,H,pe,ue,ye,q,me,fe,G,ve,ge,O,be,we,g,Ee,R,Ne,_e,Ie,W,Pe,De,$,je,Ae,A,J,Se,Te,b,Ue,w,xe,ke,Ce,E,He,N,qe,Ge,B,S,f,Y,Oe,_,v,Re;return{c(){I=d(),a=n("section"),P=n("header"),D=n("h1"),K=s("Introduction"),Q=d(),T=n("p"),Z=s(`Nymph is an ORM for Node.js and the browser, written in TypeScript. Nymph
    ...
    browse the `),N=n("a"),qe=s("Legacy API docs"),Ge=s("."),B=d(),S=n("section"),f=n("div"),Y=n("div"),Oe=d(),_=n("div"),v=n("a"),Re=s("Next: Creating Entities"),this.h()},l(u){mt("svelte-6cxoo7",document.head).forEach(t),I=c(u),a=i(u,"SECTION",{});var l=r(a);P=i(l,"HEADER",{class:!0});var Je=r(P);D=i(Je,"H1",{style:!0});var Ye=r(D);K=o(Ye,"Introduction"),Ye.forEach(t),Je.forEach(t),Q=c(l),T=i(l,"P",{});var Ve=r(T);Z=o(Ve,`Nymph is an ORM for Node.js and the browser, written in TypeScript. Nymph
    data objects, called entities, are accessed just like plain objects. Nymph
    includes a REST server and a Publish/Subscribe server. It used to be a PHP
    library and was migrated to Node.js in 2021.`),Ve.forEach(t),ee=c(l),j=i(l,"HEADER",{class:!0});var Be=r(j);U=i(Be,"H2",{});var Le=r(U);te=o(Le,"Understanding Nymph Applications"),Le.forEach(t),Be.forEach(t),ae=c(l),h=i(l,"P",{});var y=r(h);ne=o(y,"Data in Nymph is stored and manipulated in objects called "),x=i(y,"STRONG",{});var Me=r(x);se=o(Me,"entities"),Me.forEach(t),ie=o(y,`. Entities can hold most types of data available in JavaScript, including
    other entities. Entities are not strictly structured, so data of any type
    can be added and saved just by assigning a property on the entity and
    ...
    browse the `),N=i(X,"A",{href:!0,rel:!0});var ot=r(N);qe=o(ot,"Legacy API docs"),ot.forEach(t),Ge=o(X,"."),X.forEach(t),l.forEach(t),B=c(u),S=i(u,"SECTION",{});var lt=r(S);f=i(lt,"DIV",{class:!0});var z=r(f);Y=i(z,"DIV",{class:!0}),r(Y).forEach(t),Oe=c(z),_=i(z,"DIV",{class:!0,style:!0});var ht=r(_);v=i(ht,"A",{href:!0,class:!0,style:!0});var dt=r(v);Re=o(dt,"Next: Creating Entities"),dt.forEach(t),ht.forEach(t),z.forEach(t),lt.forEach(t),this.h()},h(){document.title="Introduction - User Guide - Nymph.js",We(D,"font-size","3em"),p(P,"class","major"),p(j,"class","major"),p(m,"href","https://joi.dev/"),p(m,"target","_blank"),p(m,"rel","noreferrer"),p(A,"class","major"),p(w,"href","/api/latest/"),p(w,"rel","external"),p(N,"href","/api/legacy/3.0.0/"),p(N,"rel","external"),p(Y,"class","col-6 col-12-small"),p(v,"href",ft+"/user-guide/creating-entities"),p(v,"class","button"),We(v,"margin",".5em"),p(_,"class","col-6 col-12-small"),We(_,"text-align","end"),p(f,"class","row")},m(u,V){F(u,I,V),F(u,a,V),e(a,P),e(P,D),e(D,K),e(a,Q),e(a,T),e(T,Z),e(a,ee),e(a,j),e(j,U),e(U,te),e(a,ae),e(a,h),e(h,ne),e(h,x),e(x,se),e(h,ie),e(h,k),e(k,re),e(h,oe),e(h,m),e(m,le),e(h,he),e(h,C),e(C,de),e(h,ce),e(h,H),e(H,pe),e(h,ue),e(a,ye),e(a,q),e(q,me),e(a,fe),e(a,G),e(G,ve),e(a,ge),e(a,O),e(O,be),e(a,we),e(a,g),e(g,Ee),e(g,R),e(R,Ne),e(g,_e),e(a,Ie),e(a,W),e(W,Pe),e(a,De),e(a,$),e($,je),e(a,Ae),e(a,A),e(A,J),e(J,Se),e(a,Te),e(a,b),e(b,Ue),e(b,w),e(w,xe),e(b,ke),e(a,Ce),e(a,E),e(E,He),e(E,N),e(N,qe),e(E,Ge),F(u,B,V),F(u,S,V),e(S,f),e(f,Y),e(f,Oe),e(f,_),e(_,v),e(v,Re)},p:$e,i:$e,o:$e,d(u){u&&t(I),u&&t(a),u&&t(B),u&&t(S)}}}class wt extends pt{constructor(I){super(),ut(this,I,null,vt,yt,{})}}export{wt as default};
