import{S as ys,i as fs,s as ms,R as ps,e as ds,a as h,k as o,q as t,y as ce,F as vs,T as Es,h as n,c as d,l as s,m as r,r as a,z as ue,p as Ct,n as A,C as e,b as It,A as ye,D as gs,g as fe,d as me,B as pe}from"../chunks/index.2f30a1c2.js";import{H as ve,g as $s}from"../chunks/github.8af4b809.js";import{t as Ee}from"../chunks/typescript.7dd1ec19.js";import{b as cs}from"../chunks/paths.b3a4b0de.js";function ws(us){let G,ge,pt,i,K,W,Ot,Tt,$e,kt,jt,w,Nt,we,qt,Ut,_e,Pt,At,Gt,v,St,be,Lt,xt,De,Mt,Ft,Ce,zt,Bt,Ht,S,Yt,Ie,Rt,Vt,_,Qt,Oe,Jt,Kt,Te,Wt,Xt,Zt,b,ea,ke,ta,aa,je,na,oa,sa,L,ra,x,ia,Ne,la,ha,da,M,ca,u,ua,qe,ya,fa,Ue,ma,pa,Pe,va,Ea,Ae,ga,$a,Ge,wa,_a,Se,ba,Da,Le,Ca,Ia,Oa,F,Ta,z,ka,xe,ja,Na,qa,E,B,Me,Ua,Pa,D,Fe,Aa,Ga,ze,Sa,La,Be,xa,Ma,H,He,Fa,za,C,Ye,Ba,Ha,Re,Ya,Ra,Ve,Va,Qa,m,Qe,Ja,Ka,Je,Wa,Xa,Ke,Za,en,We,tn,an,Xe,nn,on,sn,y,Ze,rn,ln,et,hn,dn,tt,cn,un,at,yn,fn,nt,mn,pn,ot,vn,En,gn,Y,$n,I,wn,st,_n,bn,rt,Dn,Cn,In,O,X,it,On,Tn,kn,Z,lt,jn,Nn,qn,ee,ht,Un,Pn,An,T,Gn,dt,Sn,Ln,ct,xn,Mn,Fn,R,zn,ut,Bn,Hn,Yn,g,Rn,yt,Vn,Qn,ft,Jn,Kn,mt,Wn,Xn,Zn,V,vt,te,k,ae,j,eo,to,Q,N,ao,Et;return S=new ve({props:{language:Ee,code:`const entity = await MyEntity.factory();
...
const success = await todo.$archive();`}}),{c(){G=new ps(!1),ge=ds(),pt=h(),i=o("section"),K=o("header"),W=o("h1"),Ot=t("Entity Class"),Tt=h(),$e=o("p"),kt=t(`Entities in Nymph work pretty much like regular objects, and this is due to
    ...
    properties up to the server, whereas `),_e=o("code"),Pt=t("$save"),At=t(" would push all properties."),Gt=h(),v=o("p"),St=t(`Entities can be organized using tags. To add, remove, and check tags, the
    ...
    arguments.`),Ht=h(),ce(S.$$.fragment),Yt=h(),Ie=o("p"),Rt=t(`In Node.js, entities that have been saved inside another entity's property
    ...
    `),Ae=o("code"),ga=t("deleteEntity"),$a=t(", and "),Ge=o("code"),wa=t("deleteEntityByID"),_a=t(` methods of
    `),Se=o("code"),ba=t("Nymph"),Da=t(". The "),Le=o("code"),Ca=t("Entity"),Ia=t(" class uses these methods."),Oa=h(),ce(F.$$.fragment),Ta=h(),z=o("p"),ka=t("Entities can't be checked using the "),xe=o("code"),ja=t("=="),Na=t(` operator. Instead, you can
    use the following entity methods.`),qa=h(),E=o("ul"),B=o("li"),Me=o("code"),Ua=t("$is"),Pa=t(` - Perform a less strict comparison of two entities
      ...
      following criteria.
      `),D=o("ul"),Fe=o("li"),Aa=t("They must be entities."),Ga=h(),ze=o("li"),Sa=t("They must have equal GUIDs, or both can have no GUID."),La=h(),Be=o("li"),xa=t("If they have no GUIDs, their data and tags must be equal."),Ma=h(),H=o("li"),He=o("code"),Fa=t("$equals"),za=t(` - Perform a more strict comparison of two entities
    ...
    `),rt=o("code"),Dn=t("$serverCall"),Cn=t(" expects three parameters."),In=h(),O=o("ul"),X=o("li"),it=o("code"),On=t("method"),Tn=t(" - the name of the method to call on the server side object."),kn=h(),Z=o("li"),lt=o("code"),jn=t("params"),Nn=t(" - an array of the parameters to pass to the method."),qn=h(),ee=o("li"),ht=o("code"),Un=t("stateless"),Pn=t(` - if set to true, the method won't update the entity
      with the returned server side representation.`),An=h(),T=o("p"),Gn=t(`Normally, when you use this method, just before the promise is fulfilled,
    ...
    to run `),dt=o("code"),Sn=t("$readyAll"),Ln=t(` again. If you know that the server side method
    ...
    properties up to the server, whereas `),_e=s(ne,"CODE",{});var co=r(_e);Pt=a(co,"$save"),co.forEach(n),At=a(ne," would push all properties."),ne.forEach(n),Gt=d(l),v=s(l,"P",{});var q=r(v);St=a(q,`Entities can be organized using tags. To add, remove, and check tags, the
    ...
    arguments.`),q.forEach(n),Ht=d(l),ue(S.$$.fragment,l),Yt=d(l),Ie=s(l,"P",{});var mo=r(Ie);Rt=a(mo,`In Node.js, entities that have been saved inside another entity's property
    are loaded as "sleeping references". This means their data is not actually
    pulled from the database. It will "wake up" when you first try to access
    ...
    use the following entity methods.`),$t.forEach(n),qa=d(l),E=s(l,"UL",{});var U=r(E);B=s(U,"LI",{});var wt=r(B);Me=s(wt,"CODE",{});var ko=r(Me);Ua=a(ko,"$is"),ko.forEach(n),Pa=a(wt,` - Perform a less strict comparison of two entities
      (basically a GUID check). To return true, the entities must meet the
      following criteria.
      `),D=s(wt,"UL",{});var re=r(D);Fe=s(re,"LI",{});var jo=r(Fe);Aa=a(jo,"They must be entities."),jo.forEach(n),Ga=d(re),ze=s(re,"LI",{});var No=r(ze);Sa=a(No,"They must have equal GUIDs, or both can have no GUID."),No.forEach(n),La=d(re),Be=s(re,"LI",{});var qo=r(Be);xa=a(qo,"If they have no GUIDs, their data and tags must be equal."),qo.forEach(n),re.forEach(n),wt.forEach(n),Ma=d(U),H=s(U,"LI",{});var _t=r(H);He=s(_t,"CODE",{});var Uo=r(He);Fa=a(Uo,"$equals"),Uo.forEach(n),za=a(_t,` - Perform a more strict comparison of two entities
      (basically a GUID + data + tags check). To return true, the entities must
      meet the following criteria.
      `),C=s(_t,"UL",{});var ie=r(C);Ye=s(ie,"LI",{});var Po=r(Ye);Ba=a(Po,"They must be entities."),Po.forEach(n),Ha=d(ie),Re=s(ie,"LI",{});var Ao=r(Re);Ya=a(Ao,"They must have equal GUIDs, or both can have no GUID."),Ao.forEach(n),Ra=d(ie),Ve=s(ie,"LI",{});var Go=r(Ve);Va=a(Go,"Their data and tags must be equal."),Go.forEach(n),ie.forEach(n),_t.forEach(n),Qa=d(U),m=s(U,"LI",{});var $=r(m);Qe=s($,"CODE",{});var So=r(Qe);Ja=a(So,"$inArray"),So.forEach(n),Ka=a($,` - Check whether the entity is in an array. Takes two
    ...
    `),rt=s(le,"CODE",{});var Jo=r(rt);Dn=a(Jo,"$serverCall"),Jo.forEach(n),Cn=a(le," expects three parameters."),le.forEach(n),In=d(l),O=s(l,"UL",{});var he=r(O);X=s(he,"LI",{});var no=r(X);it=s(no,"CODE",{});var Ko=r(it);On=a(Ko,"method"),Ko.forEach(n),Tn=a(no," - the name of the method to call on the server side object."),no.forEach(n),kn=d(he),Z=s(he,"LI",{});var oo=r(Z);lt=s(oo,"CODE",{});var Wo=r(lt);jn=a(Wo,"params"),Wo.forEach(n),Nn=a(oo," - an array of the parameters to pass to the method."),oo.forEach(n),qn=d(he),ee=s(he,"LI",{});var so=r(ee);ht=s(so,"CODE",{});var Xo=r(ht);Un=a(Xo,"stateless"),Xo.forEach(n),Pn=a(so,` - if set to true, the method won't update the entity
      with the returned server side representation.`),so.forEach(n),he.forEach(n),An=d(l),T=s(l,"P",{});var de=r(T);Gn=a(de,`Normally, when you use this method, just before the promise is fulfilled,
    the entity's data will be replaced with that of the entity on the server
    side after the method was run. This will cause any awoken entities in the
    data of your entity to be replaced with sleeping entities, so you will have
    to run `),dt=s(de,"CODE",{});var Zo=r(dt);Sn=a(Zo,"$readyAll"),Zo.forEach(n),Ln=a(de,` again. If you know that the server side method
    will not change any of the data on the entity, you can set
    ...
    guards against a user submitting tailored requests to perform potentially
    dangerous tasks on the server side. If the method is not listed, the request
    will fail with a `),mt=s(P,"CODE",{});var os=r(mt);Wn=a(os,"403 Forbidden"),os.forEach(n),Xn=a(P," status."),P.forEach(n),Zn=d(l),ue(V.$$.fragment,l),l.forEach(n),vt=d(c),te=s(c,"SECTION",{});var ss=r(te);k=s(ss,"DIV",{class:!0});var Dt=r(k);ae=s(Dt,"DIV",{class:!0});var rs=r(ae);j=s(rs,"A",{href:!0,class:!0,style:!0});var is=r(j);eo=a(is,"Previous: Subscribing to Queries"),is.forEach(n),rs.forEach(n),to=d(Dt),Q=s(Dt,"DIV",{class:!0,style:!0});var ls=r(Q);N=s(ls,"A",{href:!0,class:!0,style:!0});var hs=r(N);ao=a(hs,"Next: Defining Entities"),hs.forEach(n),ls.forEach(n),Dt.forEach(n),ss.forEach(n),this.h()},h(){document.title="Entity Class - User Guide - Nymph.js",G.a=ge,Ct(W,"font-size","3em"),A(K,"class","major"),A(j,"href",cs+"/user-guide/subscribing-to-queries"),A(j,"class","button"),Ct(j,"margin",".5em"),A(ae,"class","col-6 col-12-small"),A(N,"href",cs+"/user-guide/defining-entities"),A(N,"class","button"),Ct(N,"margin",".5em"),A(Q,"class","col-6 col-12-small"),Ct(Q,"text-align","end"),A(k,"class","row")},m(c,J){G.m($s,document.head),e(document.head,ge),It(c,pt,J),It(c,i,J),e(i,K),e(K,W),e(W,Ot),e(i,Tt),e(i,$e),e($e,kt),e(i,jt),e(i,w),e(w,Nt),e(w,we),e(we,qt),e(w,Ut),e(w,_e),e(_e,Pt),e(w,At),e(i,Gt),e(i,v),e(v,St),e(v,be),e(be,Lt),e(v,xt),e(v,De),e(De,Mt),e(v,Ft),e(v,Ce),e(Ce,zt),e(v,Bt),e(i,Ht),ye(S,i,null),e(i,Yt),e(i,Ie),e(Ie,Rt),e(i,Vt),e(i,_),e(_,Qt),e(_,Oe),e(Oe,Jt),e(_,Kt),e(_,Te),e(Te,Wt),e(_,Xt),e(i,Zt),e(i,b),e(b,ea),e(b,ke),e(ke,ta),e(b,aa),e(b,je),e(je,na),e(b,oa),e(i,sa),ye(L,i,null),e(i,ra),e(i,x),e(x,ia),e(x,Ne),e(Ne,la),e(x,ha),e(i,da),ye(M,i,null),e(i,ca),e(i,u),e(u,ua),e(u,qe),e(qe,ya),e(u,fa),e(u,Ue),e(Ue,ma),e(u,pa),e(u,Pe),e(Pe,va),e(u,Ea),e(u,Ae),e(Ae,ga),e(u,$a),e(u,Ge),e(Ge,wa),e(u,_a),e(u,Se),e(Se,ba),e(u,Da),e(u,Le),e(Le,Ca),e(u,Ia),e(i,Oa),ye(F,i,null),e(i,Ta),e(i,z),e(z,ka),e(z,xe),e(xe,ja),e(z,Na),e(i,qa),e(i,E),e(E,B),e(B,Me),e(Me,Ua),e(B,Pa),e(B,D),e(D,Fe),e(Fe,Aa),e(D,Ga),e(D,ze),e(ze,Sa),e(D,La),e(D,Be),e(Be,xa),e(E,Ma),e(E,H),e(H,He),e(He,Fa),e(H,za),e(H,C),e(C,Ye),e(Ye,Ba),e(C,Ha),e(C,Re),e(Re,Ya),e(C,Ra),e(C,Ve),e(Ve,Va),e(E,Qa),e(E,m),e(m,Qe),e(Qe,Ja),e(m,Ka),e(m,Je),e(Je,Wa),e(m,Xa),e(m,Ke),e(Ke,Za),e(m,en),e(m,We),e(We,tn),e(m,an),e(m,Xe),e(Xe,nn),e(m,on),e(E,sn),e(E,y),e(y,Ze),e(Ze,rn),e(y,ln),e(y,et),e(et,hn),e(y,dn),e(y,tt),e(tt,cn),e(y,un),e(y,at),e(at,yn),e(y,fn),e(y,nt),e(nt,mn),e(y,pn),e(y,ot),e(ot,vn),e(y,En),e(i,gn),ye(Y,i,null),e(i,$n),e(i,I),e(I,wn),e(I,st),e(st,_n),e(I,bn),e(I,rt),e(rt,Dn),e(I,Cn),e(i,In),e(i,O),e(O,X),e(X,it),e(it,On),e(X,Tn),e(O,kn),e(O,Z),e(Z,lt),e(lt,jn),e(Z,Nn),e(O,qn),e(O,ee),e(ee,ht),e(ht,Un),e(ee,Pn),e(i,An),e(i,T),e(T,Gn),e(T,dt),e(dt,Sn),e(T,Ln),e(T,ct),e(ct,xn),e(T,Mn),e(i,Fn),e(i,R),e(R,zn),e(R,ut),e(ut,Bn),e(R,Hn),e(i,Yn),e(i,g),e(g,Rn),e(g,yt),e(yt,Vn),e(g,Qn),e(g,ft),e(ft,Jn),e(g,Kn),e(g,mt),e(mt,Wn),e(g,Xn),e(i,Zn),ye(V,i,null),It(c,vt,J),It(c,te,J),e(te,k),e(k,ae),e(ae,j),e(j,eo),e(k,to),e(k,Q),e(Q,N),e(N,ao),Et=!0},p:gs,i(c){Et||(fe(S.$$.fragment,c),fe(L.$$.fragment,c),fe(M.$$.fragment,c),fe(F.$$.fragment,c),fe(Y.$$.fragment,c),fe(V.$$.fragment,c),Et=!0)},o(c){me(S.$$.fragment,c),me(L.$$.fragment,c),me(M.$$.fragment,c),me(F.$$.fragment,c),me(Y.$$.fragment,c),me(V.$$.fragment,c),Et=!1},d(c){n(ge),c&&G.d(),c&&n(pt),c&&n(i),pe(S),pe(L),pe(M),pe(F),pe(Y),pe(V),c&&n(vt),c&&n(te)}}}class Is extends ys{constructor(G){super(),fs(this,G,null,ws,ms,{})}}export{Is as default};
