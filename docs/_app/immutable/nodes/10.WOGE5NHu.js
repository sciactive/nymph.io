import{E as e,G as t,J as n,K as r,L as i,T as a,U as o,_ as s,at as c,ot as l,w as u,x as d}from"../chunks/H09IMVH7.js";import"../chunks/xihTtKlq.js";import"../chunks/D8EN8fFf.js";import{t as f}from"../chunks/D_gJAAal.js";import{t as p}from"../chunks/BF3MJUBc.js";import{t as m}from"../chunks/DDTgMnDM.js";import{t as h}from"../chunks/Ciszbs-_.js";var g=e(`<section><header class="major"><h1 style="font-size: 3em;">PubSub Server</h1></header> <p>The PubSub server provides a WebSocket server that allows Nymph to publish
    ...
    use the PubSub class directly and provide it a WebSocket server instance.</p> <!> <header class="major"><h2>Options</h2></header> <p>See the <a href="https://forge.sciactive.com/sciactive/nymphjs/src/branch/master/packages/pubsub/src/conf/index.ts" target="_blank" rel="external">config declaration file</a>.</p></section>`);function _(e){var _=g();s(`1pw5vm`,e=>{var t=a(),n=r(t);d(n,()=>h),i(()=>{o.title=`PubSub Server - Packages - Nymph.js`}),u(e,t)});var v=n(t(_),6);f(v,{get language(){return m},code:`npm install --save @nymphjs/pubsub`});var y=n(v,6);f(y,{get language(){return p},code:`import SQLite3Driver from '@nymphjs/driver-sqlite3';
...
PubSub.initPublisher(pubSubConfig, nymph);`});var b=n(y,4);f(b,{get language(){return p},code:`import SQLite3Driver from '@nymphjs/driver-sqlite3';
import { Nymph } from '@nymphjs/nymph';
...
const pubsub = createServer(8080, pubSubConfig, nymph);`});var x=n(b,4);f(x,{get language(){return p},code:`import http from 'node:http';
...
const pubsub = new PubSub(pubSubConfig, nymph, wsServer);`}),c(4),l(_),u(e,_)}export{_ as component};