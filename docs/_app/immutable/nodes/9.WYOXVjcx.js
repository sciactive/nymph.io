import{B as e,E as t,G as n,J as r,K as i,L as a,T as o,U as s,_ as c,at as l,m as u,ot as d,w as f,x as p}from"../chunks/H09IMVH7.js";import{o as m}from"../chunks/CIAV_iJ2.js";import"../chunks/xihTtKlq.js";import"../chunks/D8EN8fFf.js";import{t as h}from"../chunks/D_gJAAal.js";import{t as g}from"../chunks/BF3MJUBc.js";import{t as _}from"../chunks/DDTgMnDM.js";import{t as v}from"../chunks/Ciszbs-_.js";var y=t(`<section><header class="major"><h1 style="font-size: 3em;">Nymph</h1></header> <p>The Nymph core provides the base level classes and utilities to query the
    ...
    provide the exact same functionality.</p> <header class="major"><h2>Usage</h2></header> <p>Here's an overview:</p> <!> <!> <header class="major"><h2>Options</h2></header> <p>See the <a href="https://forge.sciactive.com/sciactive/nymphjs/src/branch/master/packages/nymph/src/conf/d.ts" target="_blank" rel="external noreferrer">config declaration file</a>.</p></section>`);function b(t){var b=y();c(`1p50s03`,e=>{var t=o(),n=i(t);p(n,()=>v),a(()=>{s.title=`Nymph - Packages - Nymph.js`}),f(e,t)});var x=r(n(b),6);h(x,{get language(){return _},code:`npm install --save @nymphjs/nymph`});var S=r(x,4),C=r(n(S)),w=r(C,2),T=r(w,2);l(),d(S);var E=r(S,6);h(E,{get language(){return g},code:`// main.ts
...
}`}),l(4),d(b),e(()=>{u(C,`href`,`${m??``}/packages/driver-mysql`),u(w,`href`,`${m??``}/packages/driver-postgresql`),u(T,`href`,`${m??``}/packages/driver-sqlite3`)}),f(t,b)}export{b as component};