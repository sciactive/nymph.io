import{B as e,E as t,G as n,J as r,K as i,L as a,T as o,U as s,_ as c,m as l,ot as u,w as d,x as f}from"../chunks/H09IMVH7.js";import{o as p}from"../chunks/C4hVk8aN.js";import"../chunks/xihTtKlq.js";import"../chunks/D8EN8fFf.js";import{t as m}from"../chunks/D_gJAAal.js";import{t as h}from"../chunks/BF3MJUBc.js";import{t as g}from"../chunks/Ciszbs-_.js";var _=t(`<section><header class="major"><h1 style="font-size: 3em;">Entity Class</h1></header> <p>Entities in Nymph work pretty much like regular objects, and this is due to
    ...
    will fail with a <code>403 Forbidden</code> status.</p> <!></section> <section class="page-steps"><a class="button" style="margin: .5em;">Previous: Subscribing to Queries</a> <a class="button" style="margin: .5em;">Next: Defining Entities</a></section>`,1);function v(t){var v=_();c(`1jwzn9u`,e=>{var t=o(),n=i(t);f(n,()=>g),a(()=>{s.title=`Entity Class - User Guide - Nymph.js`}),d(e,t)});var y=i(v),b=r(n(y),8);m(b,{get language(){return h},code:`const entity = await MyEntity.factory();

entity.$addTag('foo', 'bar');
entity.$hasTag('foo'); // True

entity.$removeTag('foo', 'bar');
entity.$hasTag('foo'); // False`});var x=r(b,6);m(x,{get language(){return h},code:`// Create some entities.
...
await entity.foo.$wake();
// End if
console.log(entity.foo.bar); // Outputs 'New value.'`});var S=r(x,4);m(S,{get language(){return h},code:`// Create an entity.
...
await entity.$refresh();
console.log(entity.foo); // Outputs 'New value.'`});var C=r(S,4);m(C,{get language(){return h},code:`const entity = await MyEntity.factory();
...
// or
await nymph.deleteEntities([entity]);`});var w=r(C,6);m(w,{get language(){return h},code:`// Assuming the entity with GUID 'a4c1591d6ea91c8450d2d360' exists.
...
entity.$inArray(arr, true); // false`});var T=r(w,12);m(T,{get language(){return h},code:`// You can use $serverCall and serverCallStatic directly.
try {
...
const success = await todo.$archive();`}),u(y);var E=r(y,2),D=n(E),O=r(D,2);u(E),e(()=>{l(D,`href`,`${p??``}/user-guide/subscribing-to-queries`),l(O,`href`,`${p??``}/user-guide/defining-entities`)}),d(t,v)}export{v as component};