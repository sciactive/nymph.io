import{C as e,G as t,H as n,I as r,K as i,T as a,W as o,b as s,g as c,it as l,w as u}from"../chunks/DZDv-zr6.js";import"../chunks/f23f8hhM.js";import"../chunks/C0cHpkde.js";import{t as d}from"../chunks/DUAD-eIe.js";import{t as f}from"../chunks/XOiHpZri.js";import{t as p}from"../chunks/DIXNzCvi.js";import{t as m}from"../chunks/jqiW6npt.js";var h=a(`<section><header class="major"><h1 style="font-size: 3em;">REST Server</h1></header> <p>The REST server lets you configure an endpoint for the Nymph client to query
    ...
    OAuth2), and place the user in <code>response.locals.user</code>.</p> <!></section>`);function g(a){var g=h();c(`cg2dh6`,i=>{var a=u();s(t(a),()=>m),r(()=>{n.title=`REST Server - Packages - Nymph.js`}),e(i,a)});var _=i(o(g),6);d(_,{get language(){return f},code:`npm install --save @nymphjs/server`});var v=i(_,6);d(v,{get language(){return p},code:`import express from 'express';
...
// Start your server.
app.listen(80);`});var y=i(v,6);d(y,{get language(){return p},code:`import { Nymph } from '@nymphjs/client';
...
const MyEntity = nymph.addEntityClass(MyEntityClass);`}),d(i(y,4),{get language(){return p},code:`import express from 'express';
import { Nymph } from '@nymphjs/nymph';
import SQLite3Driver from '@nymphjs/driver-sqlite3';
