import{C as e,G as t,H as n,I as r,K as i,T as a,W as o,b as s,g as c,it as l,p as u,rt as d,w as f,z as p}from"../chunks/DZDv-zr6.js";import{c as m}from"../chunks/k6Ybk7qv.js";import"../chunks/f23f8hhM.js";import"../chunks/C0cHpkde.js";import{t as h}from"../chunks/DUAD-eIe.js";import{t as g}from"../chunks/DIXNzCvi.js";import{t as _}from"../chunks/jqiW6npt.js";var v=a(`<section><header class="major"><h1 style="font-size: 3em;">Transactions</h1></header> <p>In Node.js, Nymph supports nested transactions. Nothing will be permanently
    ...
    children are retrieved using the proper class with <code>tnymph.getEntityClass(Todo)</code>.</p></section> <section class="page-steps"><a class="button" style="margin: .5em;">Previous: UIDs</a> <a class="button" style="margin: .5em;">Next: Full Text Search</a></section>`,1);function y(a){var y=v();c(`12sv9mp`,i=>{var a=f();s(t(a),()=>_),r(()=>{n.title=`Transactions - User Guide - Nymph.js`}),e(i,a)});var b=t(y);h(i(o(b),20),{get language(){return g},code:`import { EntityUniqueConstraintError, type Nymph } from '@nymphjs/nymph';
...
`}),d(2),l(b);var x=i(b,2),S=o(x),C=i(S,2);l(x),p(()=>{u(S,`href`,`${m??``}/user-guide/uids`),u(C,`href`,`${m??``}/user-guide/full-text-search`)}),e(a,y)}export{y as component};