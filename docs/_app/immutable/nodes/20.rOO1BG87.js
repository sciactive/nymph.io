import{h as k,a as u,t as I,c as C}from"../chunks/qRCaFh0V.js";import"../chunks/CgZvsY_p.js";import{f as m,$ as D,s as e,c as f,a as p}from"../chunks/xPuFI3q7.js";import{h as O,g as N}from"../chunks/C0NHSKHS.js";import{s as g}from"../chunks/Dx4IbXf0.js";import{t}from"../chunks/Ce9AoNbY.js";import{b as w}from"../chunks/DnMb0p-7.js";import{H as a}from"../chunks/9N_cuTOb.js";var j=I(`<section><header class="major"><h1 style="font-size: 3em;">Entity Class</h1></header> <p>Entities in Nymph work pretty much like regular objects, and this is due to
    ...
    will fail with a <code>403 Forbidden</code> status.</p> <!></section> <section class="page-steps"><a class="button" style="margin: .5em;">Previous: Subscribing to Queries</a> <a class="button" style="margin: .5em;">Next: Defining Entities</a></section>`,1);function F(v){var i=j();k(E=>{var y=C();D.title="Entity Class - User Guide - Nymph.js";var T=m(y);O(T,()=>N,!1,!1),u(E,y)});var o=m(i),n=e(f(o),8);a(n,{language:t,code:`const entity = await MyEntity.factory();

entity.$addTag('foo', 'bar');
entity.$hasTag('foo'); // True

entity.$removeTag('foo', 'bar');
entity.$hasTag('foo'); // False`});var s=e(n,6);a(s,{language:t,code:`// Create some entities.
...
await entity.foo.$wake();
// End if
console.log(entity.foo.bar); // Outputs 'New value.'`});var r=e(s,4);a(r,{language:t,code:`// Create an entity.
...
await entity.$refresh();
console.log(entity.foo); // Outputs 'New value.'`});var c=e(r,4);a(c,{language:t,code:`const entity = await MyEntity.factory();
...
// or
await nymph.deleteEntities([entity]);`});var d=e(c,6);a(d,{language:t,code:`// Assuming the entity with GUID 'a4c1591d6ea91c8450d2d360' exists.
...
entity.$inArray(arr, true); // false`});var $=e(d,12);a($,{language:t,code:`// You can use $serverCall and serverCallStatic directly.
try {
...
const success = await todo.$archive();`}),p(o);var l=e(o,2),h=f(l);g(h,"href",`${w??""}/user-guide/subscribing-to-queries`);var b=e(h,2);g(b,"href",`${w??""}/user-guide/defining-entities`),p(l),u(v,i)}export{F as component};
