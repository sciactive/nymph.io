import{B as e,E as t,G as n,J as r,K as i,L as a,T as o,U as s,_ as c,at as l,m as u,ot as d,w as f,x as p}from"../chunks/H09IMVH7.js";import{o as m}from"../chunks/CIAV_iJ2.js";import"../chunks/xihTtKlq.js";import"../chunks/D8EN8fFf.js";import{t as h}from"../chunks/D_gJAAal.js";import{t as g}from"../chunks/BF3MJUBc.js";import{t as _}from"../chunks/Ciszbs-_.js";var v=t(`<section><header class="major"><h1 style="font-size: 3em;">Transactions</h1></header> <p>In Node.js, Nymph supports nested transactions. Nothing will be permanently
    ...
    always uses these instances, every query and change should occur within that transaction.</p> <p>Since it is <strong>very</strong> important to use the right instance when
    you are using transactions, you should defined a <code>$setNymph(nymph)</code> method on all of your entities. You should use this to set <code>this.$nymph = nymph</code>, then call <code>$setNymph</code> on any
    ...
    example below uses this pattern.</p> <p>Not all databases that Nymph supports (specifically, MySQL with an engine
    ...
    methods may not, however.</p></section> <section class="page-steps"><a class="button" style="margin: .5em;">Previous: UIDs</a> <a class="button" style="margin: .5em;">Next: Full Text Search</a></section>`,1);function y(t){var y=v();c(`12sv9mp`,e=>{var t=o(),n=i(t);p(n,()=>_),a(()=>{s.title=`Transactions - User Guide - Nymph.js`}),f(e,t)});var b=i(y),x=r(n(b),22);h(x,{get language(){return g},code:`import { EntityUniqueConstraintError, type Nymph } from '@nymphjs/nymph';
