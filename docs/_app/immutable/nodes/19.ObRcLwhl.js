...
const Todo = nymph.addEntityClass(TodoClass);`}),l(x);var S=i(x,2);h(i(o(S),2),{get language(){return g},code:`import { Entity } from '@nymphjs/client';
...
// Elsewhere, after initializing Nymph.
import { Todo as TodoClass } from './Todo.js';
const Todo = nymph.addEntityClass(TodoClass);`}),l(S),d(14),l(b);var C=i(b,2),w=o(C),T=i(w,2);l(C),p(()=>{u(w,`href`,`${m??``}/user-guide/entity-class`),u(T,`href`,`${m??``}/user-guide/uids`)}),e(a,y)}export{y as component};