import{C as e,G as t,H as n,I as r,K as i,T as a,W as o,b as s,g as c,it as l,p as u,w as d,z as f}from"../chunks/DZDv-zr6.js";import{c as p}from"../chunks/k6Ybk7qv.js";import"../chunks/f23f8hhM.js";import"../chunks/C0cHpkde.js";import{t as m}from"../chunks/DUAD-eIe.js";import{t as h}from"../chunks/DIXNzCvi.js";import{t as g}from"../chunks/jqiW6npt.js";var _=a(`<section><header class="major"><h1 style="font-size: 3em;">Entity Class</h1></header> <p>Entities in Nymph work pretty much like regular objects, and this is due to
    ...
    will fail with a <code>403 Forbidden</code> status.</p> <!></section> <section class="page-steps"><a class="button" style="margin: .5em;">Previous: Subscribing to Queries</a> <a class="button" style="margin: .5em;">Next: Defining Entities</a></section>`,1);function v(a){var v=_();c(`1jwzn9u`,i=>{var a=d();s(t(a),()=>g),r(()=>{n.title=`Entity Class - User Guide - Nymph.js`}),e(i,a)});var y=t(v),b=i(o(y),8);m(b,{get language(){return h},code:`const entity = await MyEntity.factory();

entity.$addTag('foo', 'bar');
entity.$hasTag('foo'); // True

entity.$removeTag('foo', 'bar');
entity.$hasTag('foo'); // False`});var x=i(b,6);m(x,{get language(){return h},code:`// Create some entities.
...
await entity.foo.$wake();
// End if
console.log(entity.foo.bar); // Outputs 'New value.'`});var S=i(x,4);m(S,{get language(){return h},code:`// Create an entity.
...
await entity.$refresh();
console.log(entity.foo); // Outputs 'New value.'`});var C=i(S,4);m(C,{get language(){return h},code:`const entity = await MyEntity.factory();
...
// or
await nymph.deleteEntities([entity]);`});var w=i(C,6);m(w,{get language(){return h},code:`// Assuming the entity with GUID 'a4c1591d6ea91c8450d2d360' exists.
...
entity.$inArray(arr, true); // false`}),m(i(w,12),{get language(){return h},code:`// You can use $serverCall and serverCallStatic directly.
try {
...
const success = await todo.$archive();`}),l(y);var T=i(y,2),E=o(T),D=i(E,2);l(T),f(()=>{u(E,`href`,`${p??``}/user-guide/subscribing-to-queries`),u(D,`href`,`${p??``}/user-guide/defining-entities`)}),e(a,v)}export{v as component};