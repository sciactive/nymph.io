import{S as lt,i as ht,s as ct,a as c,k as i,q as a,F as dt,h as t,c as d,l as r,m as o,r as s,p as rt,n as y,b as z,C as e,D as Oe}from"../chunks/index.d7cc8d8b.js";import{b as pt}from"../chunks/paths.3059cfc3.js";function yt(ot){let _,n,I,P,F,K,j,Q,V,D,S,Z,ee,h,te,T,ne,ae,U,se,ie,f,re,oe,k,le,he,x,ce,de,pe,C,ye,ue,H,me,fe,q,ge,ve,v,be,G,we,Ee,Ne,O,_e,Ie,R,Pe,De,A,W,Ae,je,b,Se,w,Te,Ue,ke,E,xe,N,Ce,He,J,m,Y,qe,g,Ge;return{c(){_=c(),n=i("section"),I=i("header"),P=i("h1"),F=a("Introduction"),K=c(),j=i("p"),Q=a(`Nymph is an ORM for Node.js and the browser, written in TypeScript. Nymph
