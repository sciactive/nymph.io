import{f as b,a as h,c as E}from"../chunks/DFbsVUdL.js";import"../chunks/DGj7M2y4.js";import{f as l,t as N,e as j,s as e,c as t,$ as x,a,n as C}from"../chunks/uMqmAk-V.js";import{h as _,g as q}from"../chunks/BSVgqX3x.js";import{h as D,s as p}from"../chunks/Dx1ptvL_.js";import{t as m}from"../chunks/Ce9AoNbY.js";import{b as y}from"../chunks/DIlDRvmK.js";import{H as u}from"../chunks/DZfDsH_2.js";var I=b(`<section><header class="major"><h1 style="font-size: 3em;">Defining Entities</h1></header> <p>To create a new type of data object in Nymph, you extend the <code>Entity</code> class. This is equivalent to creating a new table in a relational database.
...
const Todo = nymph.addEntityClass(TodoClass);`}),a(s);var n=e(s,2),v=e(t(n),2);u(v,{get language(){return m},code:`import { Entity } from '@nymphjs/client';
...
// Elsewhere, after initializing Nymph.
import { Todo as TodoClass } from './Todo.js';
const Todo = nymph.addEntityClass(TodoClass);`}),a(n),C(14),a(o);var r=e(o,2),d=t(r),w=e(d,2);a(r),N(()=>{p(d,"href",`${y??""}/user-guide/entity-class`),p(w,"href",`${y??""}/user-guide/uids`)}),h(g,i)}export{B as component};
