import{f as c,a as i,c as m}from"../chunks/DFbsVUdL.js";import"../chunks/DGj7M2y4.js";import{f as d,e as p,s,c as f,$ as u,n as g,a as y}from"../chunks/uMqmAk-V.js";import{h as v,g as w}from"../chunks/BSVgqX3x.js";import{h as b}from"../chunks/Dx1ptvL_.js";import{b as j}from"../chunks/c8uDcNtF.js";import{t as T}from"../chunks/Ce9AoNbY.js";import{H as o}from"../chunks/DZfDsH_2.js";var k=c(`<section><header class="major"><h1 style="font-size: 3em;">Tilmeld</h1></header> <p>Tilmeld (the d is silent) is a user and group management system for Nymph.
    ...
    are specific to that instance of Nymph/Tilmeld.</p> <p>Here's an overview.</p> <!> <header class="major"><h2>Options</h2></header> <p>See the <a href="https://github.com/sciactive/nymphjs/tree/master/packages/tilmeld/src/conf/d.ts" target="_blank" rel="external">config declaration file</a>.</p> <header class="major"><h2>Abilities</h2></header> <p>There are a few abilities that Tilmeld uses internally:</p> <ul><li><code>system/admin</code> - A user with this ability has <strong>all</strong> abilities.</li> <li><code>tilmeld/admin</code> - Allow the user to manage and edit other user's
      ...
      and delete the named UID.</li></ul> <p>The admin and switch abilities cannot be inherited from groups.</p></section>`);function x(r){var e=k();b("1ivawsu",n=>{var a=m(),h=d(a);v(h,()=>w),p(()=>{u.title="Tilmeld - Packages - Nymph.js"}),i(n,a)});var t=s(f(e),6);o(t,{get language(){return j},code:"npm install --save @nymphjs/tilmeld"});var l=s(t,8);o(l,{get language(){return T},code:`import SQLite3Driver from '@nymphjs/driver-sqlite3';
...
const { User, Group } = tilmeld;`}),g(12),y(e),i(r,e)}export{x as component};
