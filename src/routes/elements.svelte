  ...
  <div class="row gtr-200">
    <div class="col-6 col-12-medium">
      ...
      <p>
        ...
        <code>fancyCode(true);</code>. Finally, this is a <a href="#">link</a>.
      </p>
      <hr />
          ...
          <ul class="icons">
            ...
            <li>
              <a href="#" class="icon" title="Facebook"
                ><Icon path={mdiFacebook} /></a
              >
            </li>
            <li>
              <a href="#" class="icon" title="Instagram"
                ><Icon path={mdiInstagram} /></a
              >
            </li>
            <li>
            ...
            <li>
              <a href="#" class="icon" title="Twitch"
                ><Icon path={mdiTwitch} /></a
              >
            </li>
          </ul>
        </div>
      ...
      <blockquote>
        ...
        faucibus. Integer ac pellentesque praesent. Lorem ipsum dolor. Lorem
        ipsum dolor vestibulum ante ipsum primis in faucibus vestibulum. Blandit
    ...
    <div class="col-6 col-12-medium">
      ...
      <ul class="actions">
        <li>
          <a href="#" class="button primary icon"
            ><Icon path={mdiMagnify} /> Icon</a
          >
        </li>
        <li>
          <a href="#" class="button icon"><Icon path={mdiDownload} /> Icon</a>
        </li>
      </ul>
      <ul class="actions">
      ...
      <span class="image fit"
        ><img
          src="https://picsum.photos/seed/sciactive/1280/416"
          alt=""
        /></span
      >
      <div class="box alt">
        <div class="row gtr-50 gtr-uniform">
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide1/416/256"
                alt=""
              /></span
            >
          </div>
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide2/416/256"
                alt=""
              /></span
            >
          </div>
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide3/416/256"
                alt=""
              /></span
            >
          </div>
          ...
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide4/416/256"
                alt=""
              /></span
            >
          </div>
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide5/416/256"
                alt=""
              /></span
            >
          </div>
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide6/416/256"
                alt=""
              /></span
            >
          </div>
          ...
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide7/416/256"
                alt=""
              /></span
            >
          </div>
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide8/416/256"
                alt=""
              /></span
            >
          </div>
          <div class="col-4">
            <span class="image fit"
              ><img
                src="https://picsum.photos/seed/slide9/416/256"
                alt=""
              /></span
            >
          </div>
      ...
      <p>
        <span class="image left"
          ><img src="https://picsum.photos/seed/foo/416/256" alt="" /></span
      ...
      <p>
        <span class="image right"
          ><img src="https://picsum.photos/seed/bar/416/256" alt="" /></span
        >Lorem ipsum dolor sit accumsan interdum nisi, quis tincidunt felis
        sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
        vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing
        accumsan eu faucibus. Integer ac pellentesque praesent tincidunt felis
