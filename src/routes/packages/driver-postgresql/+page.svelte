...
<section>
  <header class="major">
    <h1 style="font-size: 3em;">PostgreSQL Driver</h1>
  </header>

  <p>
    The PostgreSQL driver lets you configure Nymph to query and save data to a
    Postgres database.
  </p>
  ...
  <Highlight
    language={bash}
    code={`npm install --save @nymphjs/driver-postgresql`}
  />
...
// All done. Nymph is ready to use.`}
  ...
  <p>
    See the <a
      href="https://forge.sciactive.com/sciactive/nymphjs/src/branch/master/packages/driver-postgresql/src/conf/index.ts"
      target="_blank"
